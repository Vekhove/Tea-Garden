...
public class StrawberryPlantBlock extends BushBlock implements IGrowable {
    ...
    public ItemStack getItem(IBlockReader worldIn, BlockPos pos, BlockState state) {
        return new ItemStack(ItemRegistry.STRAWBERRY.get());
    }
    ...
    public ActionResultType onBlockActivated(BlockState state, World worldIn, BlockPos pos, PlayerEntity player, Hand handIn, BlockRayTraceResult hit) {
        ...
        if (age != 3 && player.getHeldItem(handIn).getItem() == Items.BONE_MEAL) {
            ...
            spawnAsEntity(worldIn, pos, new ItemStack(ItemRegistry.STRAWBERRY.get(), (age != 3 ? 1 : count)));
